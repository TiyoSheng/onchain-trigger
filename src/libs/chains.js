...
export const defaultChains = [{
  ...
  network: 'arb-mainnet',
  rpcUrl: "https://arb-mainnet.g.alchemy.com/v2/EiXW-C3n5hjVz51wqPQ2DiMC755SdNUv",
  ...
  network: 'opt-mainnet',
  rpcUrl: "https://opt-mainnet.g.alchemy.com/v2/NvzukYnwii_v0-vm6eu2KDHqNSi0h20L",
  explorer: 'https://optimistic.etherscan.io',
  symbol: 'ETH',
}, {
  chainId: 80001,
  name: 'Polygon Mumbai',
  alchemyKey: 'dvEObOGHsdlwKqC0dShjUVJyLiDqfdzC',
  network: 'polygon-mumbai',
  rpcUrl: "https://polygon-mumbai.g.alchemy.com/v2/dvEObOGHsdlwKqC0dShjUVJyLiDqfdzC",
